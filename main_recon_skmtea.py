...
from models.recon_Update import train_recon_2ch
...
def main():
    ...
    if args.challenge == 'singlecoil':
        ...
        train_data_transform = DataTransformFixedMask(args.resolution, args.challenge, mask, use_seed=False)
        ...
        if args.phase == 'train':
            ...
            # dataset_val = _create_dataset(path_dict[args.test_dataset]/args.sequence,val_data_transform, 'test', args.sequence, 2, False, 1.0)
    else:
    ...
    if args.phase == 'train':
        ...
        for iter in range(start_epoch+1,args.epochs):
            loss_avg = train_recon_2ch(net, dataset_train, optimizer, iter, args, writer)
            scheduler.step(iter)
