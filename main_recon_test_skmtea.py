...
from models.evaluation import test_recon_save_skmtea
...
if __name__ == '__main__':
    ...
    if args.challenge == 'singlecoil':
        ...
        if args.phase == 'test':
            dataset_val = _create_dataset(path_dict[args.test_dataset]/args.sequence,val_data_transform, 'test', args.sequence, 1, False, 1.0)
    else:
    ...
    if args.phase == 'test':
        ...
        metrics_dict, figure_dict = test_recon_save_skmtea(net, dataset_val, args)

        import csv

        save_path = os.path.join('results', 'ReconFormer_SKMTEA_AF{}_2CH'.format(args.accelerations[0]))
        mkdir(save_path)
